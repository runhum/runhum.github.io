...
var author$project$Page$Life$Model = F2(
	function (grid, gameState) {
		return {gameState: gameState, grid: grid};
	});
var author$project$Page$Life$Paused = {$: 'Paused'};
var author$project$Page$Life$Dead = {$: 'Dead'};
			...
			return A2(
				...
				function (row) {
					return {
						...
						state: author$project$Page$Life$Dead
					};
				});
		});
};
var author$project$Page$Life$init = function (size) {
	return _Utils_Tuple2(
		A2(
			...
			author$project$Page$Life$Paused),
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var model = {
			hoveringTab: elm$core$Maybe$Nothing,
			key: key,
...
var author$project$Page$Life$Running = {$: 'Running'};
var author$project$Page$Life$Alive = {$: 'Alive'};
...
var author$project$Page$Life$getCell = F2(
	function (position, grid) {
		var maybeRow = A2(elm$core$Array$get, position.y, grid);
		if (maybeRow.$ === 'Just') {
			var row = maybeRow.a;
			return A2(elm$core$Array$get, position.x, row);
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
...
var author$project$Page$Life$getNeighbourCount = F2(
	function (cell, grid) {
		...
		var neighbours = A2(
			...
			function (c) {
				return _Utils_eq(c.state, author$project$Page$Life$Alive);
			},
			A2(
...
var author$project$Page$Life$updateCellState = F2(
	function (cell, neighbourCount) {
		var _n0 = _Utils_Tuple2(cell.state, neighbourCount);
		_n0$3:
		while (true) {
			if (_n0.a.$ === 'Alive') {
				switch (_n0.b) {
					case 2:
						var _n1 = _n0.a;
						return author$project$Page$Life$Alive;
					case 3:
						var _n2 = _n0.a;
						return author$project$Page$Life$Alive;
					default:
		...
		return author$project$Page$Life$Dead;
	});
				...
				function (cell) {
					return {
						...
						state: A2(
							...
							cell,
							A2(author$project$Page$Life$getNeighbourCount, cell, model.grid))
					};
				},
				row);
		},
...
var author$project$Page$Life$toggleCellState = function (cell) {
	...
	return {position: cell.position, state: newState};
};
...
var author$project$Page$Life$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'DidTapCell':
				var cell = msg.a;
				var row = A2(elm$core$Array$get, cell.position.y, model.grid);
				...
				var updatedGrid = A3(elm$core$Array$set, cell.position.y, newArray, model.grid);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{grid: updatedGrid}),
				...
				if (_n2.$ === 'Running') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								grid: author$project$Page$Life$generateNext(model)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			default:
				var newGameState = function () {
					...
					if (_n3.$ === 'Running') {
						return author$project$Page$Life$Paused;
					} else {
						return author$project$Page$Life$Running;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
				...
				case 'UrlChanged':
					...
					return author$project$Main$loadPage(
						_Utils_Tuple2(
							...
							elm$core$Platform$Cmd$none));
				case 'NavBarTabHovered':
					var tab = _n0.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								hoveringTab: elm$core$Maybe$Just(tab)
							}),
						elm$core$Platform$Cmd$none);
				case 'HomeMsg':
					if (_n0.b.$ === 'Home') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: author$project$Page$Page$Home(newPageModel)
								}),
					...
					if (_n0.b.$ === 'Life') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: author$project$Page$Page$Life(newPageModel)
								}),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					angle: 1,
					steps: author$project$Page$Life$getCellColors(cell)
				}),
		...
		[
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Font$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 199, 199, 204))
				]),
			{
				label: mdgriffith$elm_ui$Element$text('Made with Elm'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					label: mdgriffith$elm_ui$Element$text('Runar Hummelsund'),
				...
				_List_fromArray(
					[mdgriffith$elm_ui$Element$alignRight]),
				{
					label: mdgriffith$elm_ui$Element$text('Life'),
					url: author$project$Route$routeToString(author$project$Route$GameOfLife)
				})
			]));
};
